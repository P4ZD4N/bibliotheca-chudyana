...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/reviews-management", "/reviews-management/find-review", "/reviews-management/delete-review").hasAnyRole( "MANAGER", "ADMIN")
                .requestMatchers("/add-review-for-{bookId}", "/reviews-management/update-review", "/reviews-management/save-review").hasAnyRole("USER", "EMPLOYEE", "MANAGER", "ADMIN")
